...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceChallengeEventParticipantResource();
  });
  ...
  describe('PageResourceChallengeEventParticipantResource', function() {
    it('should create an instance of PageResourceChallengeEventParticipantResource', function() {
      // uncomment below and update the code to test PageResourceChallengeEventParticipantResource
      //var instane = new KnetikCloud.PageResourceChallengeEventParticipantResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceChallengeEventParticipantResource);
    });
