...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceMessageTemplateResource();
  });
  ...
  describe('PageResourceMessageTemplateResource', function() {
    it('should create an instance of PageResourceMessageTemplateResource', function() {
      // uncomment below and update the code to test PageResourceMessageTemplateResource
      //var instane = new KnetikCloud.PageResourceMessageTemplateResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceMessageTemplateResource);
    });
