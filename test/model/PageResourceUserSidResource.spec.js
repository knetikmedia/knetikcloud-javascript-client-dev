...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceUserSidResource();
  });
  ...
  describe('PageResourceUserSidResource', function() {
    it('should create an instance of PageResourceUserSidResource', function() {
      // uncomment below and update the code to test PageResourceUserSidResource
      //var instane = new KnetikCloud.PageResourceUserSidResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceUserSidResource);
    });
