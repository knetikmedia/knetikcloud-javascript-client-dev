...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourcePollResource();
  });
  ...
  describe('PageResourcePollResource', function() {
    it('should create an instance of PageResourcePollResource', function() {
      // uncomment below and update the code to test PageResourcePollResource
      //var instane = new KnetikCloud.PageResourcePollResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourcePollResource);
    });
