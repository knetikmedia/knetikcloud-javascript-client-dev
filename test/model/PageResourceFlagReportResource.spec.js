...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceFlagReportResource();
  });
  ...
  describe('PageResourceFlagReportResource', function() {
    it('should create an instance of PageResourceFlagReportResource', function() {
      // uncomment below and update the code to test PageResourceFlagReportResource
      //var instane = new KnetikCloud.PageResourceFlagReportResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceFlagReportResource);
    });
