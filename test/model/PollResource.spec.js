...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PollResource();
  });
  ...
  describe('PollResource', function() {
    it('should create an instance of PollResource', function() {
      // uncomment below and update the code to test PollResource
      //var instane = new KnetikCloud.PollResource();
      //expect(instance).to.be.a(KnetikCloud.PollResource);
    });
