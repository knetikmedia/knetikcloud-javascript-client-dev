...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.SelectedSettingResource();
  });
  ...
  describe('SelectedSettingResource', function() {
    it('should create an instance of SelectedSettingResource', function() {
      ...
      //var instane = new KnetikCloud.SelectedSettingResource();
      //expect(instance).to.be.a(KnetikCloud.SelectedSettingResource);
    });
