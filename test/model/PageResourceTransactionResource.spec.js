...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceTransactionResource();
  });
  ...
  describe('PageResourceTransactionResource', function() {
    it('should create an instance of PageResourceTransactionResource', function() {
      // uncomment below and update the code to test PageResourceTransactionResource
      //var instane = new KnetikCloud.PageResourceTransactionResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceTransactionResource);
    });
