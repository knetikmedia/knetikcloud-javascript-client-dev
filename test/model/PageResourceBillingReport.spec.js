...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceBillingReport();
  });
  ...
  describe('PageResourceBillingReport', function() {
    it('should create an instance of PageResourceBillingReport', function() {
      // uncomment below and update the code to test PageResourceBillingReport
      //var instane = new KnetikCloud.PageResourceBillingReport();
      //expect(instance).to.be.a(KnetikCloud.PageResourceBillingReport);
    });
