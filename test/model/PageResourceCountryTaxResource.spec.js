...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceCountryTaxResource();
  });
  ...
  describe('PageResourceCountryTaxResource', function() {
    it('should create an instance of PageResourceCountryTaxResource', function() {
      // uncomment below and update the code to test PageResourceCountryTaxResource
      //var instane = new KnetikCloud.PageResourceCountryTaxResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceCountryTaxResource);
    });
