...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceStoreItem();
  });
  ...
  describe('PageResourceStoreItem', function() {
    it('should create an instance of PageResourceStoreItem', function() {
      // uncomment below and update the code to test PageResourceStoreItem
      //var instane = new KnetikCloud.PageResourceStoreItem();
      //expect(instance).to.be.a(KnetikCloud.PageResourceStoreItem);
    });
