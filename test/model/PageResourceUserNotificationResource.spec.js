...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceUserNotificationResource();
  });
  ...
  describe('PageResourceUserNotificationResource', function() {
    it('should create an instance of PageResourceUserNotificationResource', function() {
      // uncomment below and update the code to test PageResourceUserNotificationResource
      //var instane = new KnetikCloud.PageResourceUserNotificationResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceUserNotificationResource);
    });
