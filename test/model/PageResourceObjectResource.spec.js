...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceObjectResource();
  });
  ...
  describe('PageResourceObjectResource', function() {
    it('should create an instance of PageResourceObjectResource', function() {
      // uncomment below and update the code to test PageResourceObjectResource
      //var instane = new KnetikCloud.PageResourceObjectResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceObjectResource);
    });
