...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceFulfillmentType();
  });
  ...
  describe('PageResourceFulfillmentType', function() {
    it('should create an instance of PageResourceFulfillmentType', function() {
      // uncomment below and update the code to test PageResourceFulfillmentType
      //var instane = new KnetikCloud.PageResourceFulfillmentType();
      //expect(instance).to.be.a(KnetikCloud.PageResourceFulfillmentType);
    });
