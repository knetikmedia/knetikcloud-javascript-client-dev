...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceCommentResource();
  });
  ...
  describe('PageResourceCommentResource', function() {
    it('should create an instance of PageResourceCommentResource', function() {
      // uncomment below and update the code to test PageResourceCommentResource
      //var instane = new KnetikCloud.PageResourceCommentResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceCommentResource);
    });
