...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.MapResource();
  });
  ...
  describe('MapResource', function() {
    it('should create an instance of MapResource', function() {
      // uncomment below and update the code to test MapResource
      //var instane = new KnetikCloud.MapResource();
      //expect(instance).to.be.a(KnetikCloud.MapResource);
    });
