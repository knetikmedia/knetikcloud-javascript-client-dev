...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceChallengeEventResource();
  });
  ...
  describe('PageResourceChallengeEventResource', function() {
    it('should create an instance of PageResourceChallengeEventResource', function() {
      // uncomment below and update the code to test PageResourceChallengeEventResource
      //var instane = new KnetikCloud.PageResourceChallengeEventResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceChallengeEventResource);
    });
