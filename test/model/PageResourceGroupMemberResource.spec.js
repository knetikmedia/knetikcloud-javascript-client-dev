...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceGroupMemberResource();
  });
  ...
  describe('PageResourceGroupMemberResource', function() {
    it('should create an instance of PageResourceGroupMemberResource', function() {
      // uncomment below and update the code to test PageResourceGroupMemberResource
      //var instane = new KnetikCloud.PageResourceGroupMemberResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceGroupMemberResource);
    });
