...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceDispositionResource();
  });
  ...
  describe('PageResourceDispositionResource', function() {
    it('should create an instance of PageResourceDispositionResource', function() {
      // uncomment below and update the code to test PageResourceDispositionResource
      //var instane = new KnetikCloud.PageResourceDispositionResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceDispositionResource);
    });
