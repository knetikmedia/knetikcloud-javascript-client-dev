...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceUserRelationshipResource();
  });
  ...
  describe('PageResourceUserRelationshipResource', function() {
    it('should create an instance of PageResourceUserRelationshipResource', function() {
      // uncomment below and update the code to test PageResourceUserRelationshipResource
      //var instane = new KnetikCloud.PageResourceUserRelationshipResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceUserRelationshipResource);
    });
