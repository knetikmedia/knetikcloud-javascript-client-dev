...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceVideoRelationshipResource();
  });
  ...
  describe('PageResourceVideoRelationshipResource', function() {
    it('should create an instance of PageResourceVideoRelationshipResource', function() {
      // uncomment below and update the code to test PageResourceVideoRelationshipResource
      //var instane = new KnetikCloud.PageResourceVideoRelationshipResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceVideoRelationshipResource);
    });
