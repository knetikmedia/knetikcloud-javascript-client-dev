...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceUserInventoryResource();
  });
  ...
  describe('PageResourceUserInventoryResource', function() {
    it('should create an instance of PageResourceUserInventoryResource', function() {
      ...
      //var instane = new KnetikCloud.PageResourceUserInventoryResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceUserInventoryResource);
    });
