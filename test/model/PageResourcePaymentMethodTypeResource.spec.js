...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourcePaymentMethodTypeResource();
  });
  ...
  describe('PageResourcePaymentMethodTypeResource', function() {
    it('should create an instance of PageResourcePaymentMethodTypeResource', function() {
      // uncomment below and update the code to test PageResourcePaymentMethodTypeResource
      //var instane = new KnetikCloud.PageResourcePaymentMethodTypeResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourcePaymentMethodTypeResource);
    });
