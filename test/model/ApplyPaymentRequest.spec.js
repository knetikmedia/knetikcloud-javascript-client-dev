...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.ApplyPaymentRequest();
  });
  ...
  describe('ApplyPaymentRequest', function() {
    it('should create an instance of ApplyPaymentRequest', function() {
      // uncomment below and update the code to test ApplyPaymentRequest
      //var instane = new KnetikCloud.ApplyPaymentRequest();
      //expect(instance).to.be.a(KnetikCloud.ApplyPaymentRequest);
    });
