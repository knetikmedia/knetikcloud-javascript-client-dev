...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceInvoiceLogEntry();
  });
  ...
  describe('PageResourceInvoiceLogEntry', function() {
    it('should create an instance of PageResourceInvoiceLogEntry', function() {
      // uncomment below and update the code to test PageResourceInvoiceLogEntry
      //var instane = new KnetikCloud.PageResourceInvoiceLogEntry();
      //expect(instance).to.be.a(KnetikCloud.PageResourceInvoiceLogEntry);
    });
