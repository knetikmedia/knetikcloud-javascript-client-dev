...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceRevenueProductReportResource();
  });
  ...
  describe('PageResourceRevenueProductReportResource', function() {
    it('should create an instance of PageResourceRevenueProductReportResource', function() {
      // uncomment below and update the code to test PageResourceRevenueProductReportResource
      //var instane = new KnetikCloud.PageResourceRevenueProductReportResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceRevenueProductReportResource);
    });
