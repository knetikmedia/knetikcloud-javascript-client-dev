...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceRoleResource();
  });
  ...
  describe('PageResourceRoleResource', function() {
    it('should create an instance of PageResourceRoleResource', function() {
      // uncomment below and update the code to test PageResourceRoleResource
      //var instane = new KnetikCloud.PageResourceRoleResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceRoleResource);
    });
