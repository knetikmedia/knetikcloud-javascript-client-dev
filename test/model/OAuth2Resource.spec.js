...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.OAuth2Resource();
  });
  ...
  describe('OAuth2Resource', function() {
    it('should create an instance of OAuth2Resource', function() {
      // uncomment below and update the code to test OAuth2Resource
      //var instane = new KnetikCloud.OAuth2Resource();
      //expect(instance).to.be.a(KnetikCloud.OAuth2Resource);
    });
