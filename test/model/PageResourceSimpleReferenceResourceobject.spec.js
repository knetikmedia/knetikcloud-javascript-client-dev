...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceSimpleReferenceResourceobject();
  });
  ...
  describe('PageResourceSimpleReferenceResourceobject', function() {
    it('should create an instance of PageResourceSimpleReferenceResourceobject', function() {
      // uncomment below and update the code to test PageResourceSimpleReferenceResourceobject
      //var instane = new KnetikCloud.PageResourceSimpleReferenceResourceobject();
      //expect(instance).to.be.a(KnetikCloud.PageResourceSimpleReferenceResourceobject);
    });
