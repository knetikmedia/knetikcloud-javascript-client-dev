...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.VideoPropertyDefinitionResource();
  });
  ...
  describe('VideoPropertyDefinitionResource', function() {
    it('should create an instance of VideoPropertyDefinitionResource', function() {
      // uncomment below and update the code to test VideoPropertyDefinitionResource
      //var instane = new KnetikCloud.VideoPropertyDefinitionResource();
      //expect(instance).to.be.a(KnetikCloud.VideoPropertyDefinitionResource);
    });
