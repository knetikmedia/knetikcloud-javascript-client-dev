...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceUserAchievementGroupResource();
  });
  ...
  describe('PageResourceUserAchievementGroupResource', function() {
    it('should create an instance of PageResourceUserAchievementGroupResource', function() {
      // uncomment below and update the code to test PageResourceUserAchievementGroupResource
      //var instane = new KnetikCloud.PageResourceUserAchievementGroupResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceUserAchievementGroupResource);
    });
