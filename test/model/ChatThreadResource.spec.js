...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.ChatThreadResource();
  });
  ...
  describe('ChatThreadResource', function() {
    it('should create an instance of ChatThreadResource', function() {
      // uncomment below and update the code to test ChatThreadResource
      //var instane = new KnetikCloud.ChatThreadResource();
      //expect(instance).to.be.a(KnetikCloud.ChatThreadResource);
    });
