...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceImportJobResource();
  });
  ...
  describe('PageResourceImportJobResource', function() {
    it('should create an instance of PageResourceImportJobResource', function() {
      ...
      //var instane = new KnetikCloud.PageResourceImportJobResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceImportJobResource);
    });
