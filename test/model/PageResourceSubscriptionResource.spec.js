...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceSubscriptionResource();
  });
  ...
  describe('PageResourceSubscriptionResource', function() {
    it('should create an instance of PageResourceSubscriptionResource', function() {
      // uncomment below and update the code to test PageResourceSubscriptionResource
      //var instane = new KnetikCloud.PageResourceSubscriptionResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceSubscriptionResource);
    });
