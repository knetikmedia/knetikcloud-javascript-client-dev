...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceSubscriptionTemplateResource();
  });
  ...
  describe('PageResourceSubscriptionTemplateResource', function() {
    it('should create an instance of PageResourceSubscriptionTemplateResource', function() {
      // uncomment below and update the code to test PageResourceSubscriptionTemplateResource
      //var instane = new KnetikCloud.PageResourceSubscriptionTemplateResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceSubscriptionTemplateResource);
    });
