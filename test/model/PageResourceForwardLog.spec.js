...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceForwardLog();
  });
  ...
  describe('PageResourceForwardLog', function() {
    it('should create an instance of PageResourceForwardLog', function() {
      // uncomment below and update the code to test PageResourceForwardLog
      //var instane = new KnetikCloud.PageResourceForwardLog();
      //expect(instance).to.be.a(KnetikCloud.PageResourceForwardLog);
    });
