...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceChallengeResource();
  });
  ...
  describe('PageResourceChallengeResource', function() {
    it('should create an instance of PageResourceChallengeResource', function() {
      // uncomment below and update the code to test PageResourceChallengeResource
      //var instane = new KnetikCloud.PageResourceChallengeResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceChallengeResource);
    });
