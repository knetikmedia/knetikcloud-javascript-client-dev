...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceBreTriggerResource();
  });
  ...
  describe('PageResourceBreTriggerResource', function() {
    it('should create an instance of PageResourceBreTriggerResource', function() {
      // uncomment below and update the code to test PageResourceBreTriggerResource
      //var instane = new KnetikCloud.PageResourceBreTriggerResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceBreTriggerResource);
    });
