...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceMonitoringIncidentResource();
  });
  ...
  describe('PageResourceMonitoringIncidentResource', function() {
    it('should create an instance of PageResourceMonitoringIncidentResource', function() {
      // uncomment below and update the code to test PageResourceMonitoringIncidentResource
      //var instane = new KnetikCloud.PageResourceMonitoringIncidentResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceMonitoringIncidentResource);
    });
