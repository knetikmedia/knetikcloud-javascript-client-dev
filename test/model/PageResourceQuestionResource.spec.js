...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceQuestionResource();
  });
  ...
  describe('PageResourceQuestionResource', function() {
    it('should create an instance of PageResourceQuestionResource', function() {
      // uncomment below and update the code to test PageResourceQuestionResource
      //var instane = new KnetikCloud.PageResourceQuestionResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceQuestionResource);
    });
