...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceItemTemplateResource();
  });
  ...
  describe('PageResourceItemTemplateResource', function() {
    it('should create an instance of PageResourceItemTemplateResource', function() {
      // uncomment below and update the code to test PageResourceItemTemplateResource
      //var instane = new KnetikCloud.PageResourceItemTemplateResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceItemTemplateResource);
    });
