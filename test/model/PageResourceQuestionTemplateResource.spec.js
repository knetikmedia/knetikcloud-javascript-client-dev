...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceQuestionTemplateResource();
  });
  ...
  describe('PageResourceQuestionTemplateResource', function() {
    it('should create an instance of PageResourceQuestionTemplateResource', function() {
      // uncomment below and update the code to test PageResourceQuestionTemplateResource
      //var instane = new KnetikCloud.PageResourceQuestionTemplateResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceQuestionTemplateResource);
    });
