...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceStateTaxResource();
  });
  ...
  describe('PageResourceStateTaxResource', function() {
    it('should create an instance of PageResourceStateTaxResource', function() {
      // uncomment below and update the code to test PageResourceStateTaxResource
      //var instane = new KnetikCloud.PageResourceStateTaxResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceStateTaxResource);
    });
