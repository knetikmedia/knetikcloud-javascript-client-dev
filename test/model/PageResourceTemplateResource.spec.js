...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceTemplateResource();
  });
  ...
  describe('PageResourceTemplateResource', function() {
    it('should create an instance of PageResourceTemplateResource', function() {
      // uncomment below and update the code to test PageResourceTemplateResource
      //var instane = new KnetikCloud.PageResourceTemplateResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceTemplateResource);
    });
