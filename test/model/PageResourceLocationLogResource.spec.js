...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceLocationLogResource();
  });
  ...
  describe('PageResourceLocationLogResource', function() {
    it('should create an instance of PageResourceLocationLogResource', function() {
      // uncomment below and update the code to test PageResourceLocationLogResource
      //var instane = new KnetikCloud.PageResourceLocationLogResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceLocationLogResource);
    });
