...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceBareChallengeActivityResource();
  });
  ...
  describe('PageResourceBareChallengeActivityResource', function() {
    it('should create an instance of PageResourceBareChallengeActivityResource', function() {
      // uncomment below and update the code to test PageResourceBareChallengeActivityResource
      //var instane = new KnetikCloud.PageResourceBareChallengeActivityResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceBareChallengeActivityResource);
    });
