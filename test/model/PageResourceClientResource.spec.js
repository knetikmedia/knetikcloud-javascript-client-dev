...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceClientResource();
  });
  ...
  describe('PageResourceClientResource', function() {
    it('should create an instance of PageResourceClientResource', function() {
      // uncomment below and update the code to test PageResourceClientResource
      //var instane = new KnetikCloud.PageResourceClientResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceClientResource);
    });
