...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceChatMessageResource();
  });
  ...
  describe('PageResourceChatMessageResource', function() {
    it('should create an instance of PageResourceChatMessageResource', function() {
      // uncomment below and update the code to test PageResourceChatMessageResource
      //var instane = new KnetikCloud.PageResourceChatMessageResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceChatMessageResource);
    });
