...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceStoreItemTemplateResource();
  });
  ...
  describe('PageResourceStoreItemTemplateResource', function() {
    it('should create an instance of PageResourceStoreItemTemplateResource', function() {
      // uncomment below and update the code to test PageResourceStoreItemTemplateResource
      //var instane = new KnetikCloud.PageResourceStoreItemTemplateResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceStoreItemTemplateResource);
    });
