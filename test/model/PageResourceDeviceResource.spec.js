...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceDeviceResource();
  });
  ...
  describe('PageResourceDeviceResource', function() {
    it('should create an instance of PageResourceDeviceResource', function() {
      // uncomment below and update the code to test PageResourceDeviceResource
      //var instane = new KnetikCloud.PageResourceDeviceResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceDeviceResource);
    });
