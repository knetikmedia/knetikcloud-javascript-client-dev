...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourcePermissionResource();
  });
  ...
  describe('PageResourcePermissionResource', function() {
    it('should create an instance of PageResourcePermissionResource', function() {
      // uncomment below and update the code to test PageResourcePermissionResource
      //var instane = new KnetikCloud.PageResourcePermissionResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourcePermissionResource);
    });
