...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceWalletTotalResponse();
  });
  ...
  describe('PageResourceWalletTotalResponse', function() {
    it('should create an instance of PageResourceWalletTotalResponse', function() {
      // uncomment below and update the code to test PageResourceWalletTotalResponse
      //var instane = new KnetikCloud.PageResourceWalletTotalResponse();
      //expect(instance).to.be.a(KnetikCloud.PageResourceWalletTotalResponse);
    });
