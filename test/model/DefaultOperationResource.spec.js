...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.DefaultOperationResource();
  });
  ...
  describe('DefaultOperationResource', function() {
    it('should create an instance of DefaultOperationResource', function() {
      // uncomment below and update the code to test DefaultOperationResource
      //var instane = new KnetikCloud.DefaultOperationResource();
      //expect(instance).to.be.a(KnetikCloud.DefaultOperationResource);
    });
