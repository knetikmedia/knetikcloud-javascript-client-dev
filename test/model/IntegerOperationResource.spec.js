...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.IntegerOperationResource();
  });
  ...
  describe('IntegerOperationResource', function() {
    it('should create an instance of IntegerOperationResource', function() {
      // uncomment below and update the code to test IntegerOperationResource
      //var instane = new KnetikCloud.IntegerOperationResource();
      //expect(instance).to.be.a(KnetikCloud.IntegerOperationResource);
    });
