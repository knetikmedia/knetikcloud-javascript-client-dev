...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceBreRule();
  });
  ...
  describe('PageResourceBreRule', function() {
    it('should create an instance of PageResourceBreRule', function() {
      // uncomment below and update the code to test PageResourceBreRule
      //var instane = new KnetikCloud.PageResourceBreRule();
      //expect(instance).to.be.a(KnetikCloud.PageResourceBreRule);
    });
