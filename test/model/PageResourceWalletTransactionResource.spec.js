...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceWalletTransactionResource();
  });
  ...
  describe('PageResourceWalletTransactionResource', function() {
    it('should create an instance of PageResourceWalletTransactionResource', function() {
      // uncomment below and update the code to test PageResourceWalletTransactionResource
      //var instane = new KnetikCloud.PageResourceWalletTransactionResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceWalletTransactionResource);
    });
