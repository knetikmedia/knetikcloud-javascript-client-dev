...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.ImageGroupPropertyDefinitionResource();
  });
  ...
  describe('ImageGroupPropertyDefinitionResource', function() {
    it('should create an instance of ImageGroupPropertyDefinitionResource', function() {
      ...
      //var instane = new KnetikCloud.ImageGroupPropertyDefinitionResource();
      //expect(instance).to.be.a(KnetikCloud.ImageGroupPropertyDefinitionResource);
    });
