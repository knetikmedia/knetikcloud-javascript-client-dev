...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceOauthAccessTokenResource();
  });
  ...
  describe('PageResourceOauthAccessTokenResource', function() {
    it('should create an instance of PageResourceOauthAccessTokenResource', function() {
      // uncomment below and update the code to test PageResourceOauthAccessTokenResource
      //var instane = new KnetikCloud.PageResourceOauthAccessTokenResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceOauthAccessTokenResource);
    });
