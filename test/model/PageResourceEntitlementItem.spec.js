...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceEntitlementItem();
  });
  ...
  describe('PageResourceEntitlementItem', function() {
    it('should create an instance of PageResourceEntitlementItem', function() {
      // uncomment below and update the code to test PageResourceEntitlementItem
      //var instane = new KnetikCloud.PageResourceEntitlementItem();
      //expect(instance).to.be.a(KnetikCloud.PageResourceEntitlementItem);
    });
