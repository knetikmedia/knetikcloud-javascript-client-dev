...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.AccessTypeResource();
  });
  ...
  describe('AccessTypeResource', function() {
    it('should create an instance of AccessTypeResource', function() {
      // uncomment below and update the code to test AccessTypeResource
      //var instane = new KnetikCloud.AccessTypeResource();
      //expect(instance).to.be.a(KnetikCloud.AccessTypeResource);
    });
