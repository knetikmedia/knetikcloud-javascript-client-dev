...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceFlagResource();
  });
  ...
  describe('PageResourceFlagResource', function() {
    it('should create an instance of PageResourceFlagResource', function() {
      // uncomment below and update the code to test PageResourceFlagResource
      //var instane = new KnetikCloud.PageResourceFlagResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceFlagResource);
    });
