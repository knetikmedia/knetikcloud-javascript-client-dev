...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceAggregateInvoiceReportResource();
  });
  ...
  describe('PageResourceAggregateInvoiceReportResource', function() {
    it('should create an instance of PageResourceAggregateInvoiceReportResource', function() {
      // uncomment below and update the code to test PageResourceAggregateInvoiceReportResource
      //var instane = new KnetikCloud.PageResourceAggregateInvoiceReportResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceAggregateInvoiceReportResource);
    });
