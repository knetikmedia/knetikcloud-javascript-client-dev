...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceVideoResource();
  });
  ...
  describe('PageResourceVideoResource', function() {
    it('should create an instance of PageResourceVideoResource', function() {
      // uncomment below and update the code to test PageResourceVideoResource
      //var instane = new KnetikCloud.PageResourceVideoResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceVideoResource);
    });
