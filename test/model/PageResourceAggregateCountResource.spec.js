...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceAggregateCountResource();
  });
  ...
  describe('PageResourceAggregateCountResource', function() {
    it('should create an instance of PageResourceAggregateCountResource', function() {
      // uncomment below and update the code to test PageResourceAggregateCountResource
      //var instane = new KnetikCloud.PageResourceAggregateCountResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceAggregateCountResource);
    });
