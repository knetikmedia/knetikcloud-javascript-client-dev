...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.ChallengeActivityResource();
  });
  ...
  describe('ChallengeActivityResource', function() {
    it('should create an instance of ChallengeActivityResource', function() {
      // uncomment below and update the code to test ChallengeActivityResource
      //var instane = new KnetikCloud.ChallengeActivityResource();
      //expect(instance).to.be.a(KnetikCloud.ChallengeActivityResource);
    });
