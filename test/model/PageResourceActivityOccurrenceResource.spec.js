...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceActivityOccurrenceResource();
  });
  ...
  describe('PageResourceActivityOccurrenceResource', function() {
    it('should create an instance of PageResourceActivityOccurrenceResource', function() {
      // uncomment below and update the code to test PageResourceActivityOccurrenceResource
      //var instane = new KnetikCloud.PageResourceActivityOccurrenceResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceActivityOccurrenceResource);
    });
