...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceAccessTypeResource();
  });
  ...
  describe('PageResourceAccessTypeResource', function() {
    it('should create an instance of PageResourceAccessTypeResource', function() {
      // uncomment below and update the code to test PageResourceAccessTypeResource
      //var instane = new KnetikCloud.PageResourceAccessTypeResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceAccessTypeResource);
    });
