...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.ObjectResource();
  });
  ...
  describe('ObjectResource', function() {
    it('should create an instance of ObjectResource', function() {
      // uncomment below and update the code to test ObjectResource
      //var instane = new KnetikCloud.ObjectResource();
      //expect(instance).to.be.a(KnetikCloud.ObjectResource);
    });
