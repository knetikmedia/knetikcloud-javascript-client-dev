...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceCurrencyResource();
  });
  ...
  describe('PageResourceCurrencyResource', function() {
    it('should create an instance of PageResourceCurrencyResource', function() {
      // uncomment below and update the code to test PageResourceCurrencyResource
      //var instane = new KnetikCloud.PageResourceCurrencyResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceCurrencyResource);
    });
