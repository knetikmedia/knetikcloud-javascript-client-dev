...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.ActivityOccurrenceJoinResult();
  });
  ...
  describe('ActivityOccurrenceJoinResult', function() {
    it('should create an instance of ActivityOccurrenceJoinResult', function() {
      ...
      //var instane = new KnetikCloud.ActivityOccurrenceJoinResult();
      //expect(instance).to.be.a(KnetikCloud.ActivityOccurrenceJoinResult);
    });
