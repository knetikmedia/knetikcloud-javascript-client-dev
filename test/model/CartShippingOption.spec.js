...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.CartShippingOption();
  });
  ...
  describe('CartShippingOption', function() {
    it('should create an instance of CartShippingOption', function() {
      // uncomment below and update the code to test CartShippingOption
      //var instane = new KnetikCloud.CartShippingOption();
      //expect(instance).to.be.a(KnetikCloud.CartShippingOption);
    });
