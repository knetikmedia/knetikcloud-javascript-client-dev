...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.MonitoringAlertResource();
  });
  ...
  describe('MonitoringAlertResource', function() {
    it('should create an instance of MonitoringAlertResource', function() {
      // uncomment below and update the code to test MonitoringAlertResource
      //var instane = new KnetikCloud.MonitoringAlertResource();
      //expect(instance).to.be.a(KnetikCloud.MonitoringAlertResource);
    });
