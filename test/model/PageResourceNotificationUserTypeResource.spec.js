...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceNotificationUserTypeResource();
  });
  ...
  describe('PageResourceNotificationUserTypeResource', function() {
    it('should create an instance of PageResourceNotificationUserTypeResource', function() {
      // uncomment below and update the code to test PageResourceNotificationUserTypeResource
      //var instane = new KnetikCloud.PageResourceNotificationUserTypeResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceNotificationUserTypeResource);
    });
