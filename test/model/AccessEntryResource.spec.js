...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.AccessEntryResource();
  });
  ...
  describe('AccessEntryResource', function() {
    it('should create an instance of AccessEntryResource', function() {
      // uncomment below and update the code to test AccessEntryResource
      //var instane = new KnetikCloud.AccessEntryResource();
      //expect(instance).to.be.a(KnetikCloud.AccessEntryResource);
    });
