...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.CoreActivitySettings();
  });
  ...
  describe('CoreActivitySettings', function() {
    it('should create an instance of CoreActivitySettings', function() {
      // uncomment below and update the code to test CoreActivitySettings
      //var instane = new KnetikCloud.CoreActivitySettings();
      //expect(instance).to.be.a(KnetikCloud.CoreActivitySettings);
    });
