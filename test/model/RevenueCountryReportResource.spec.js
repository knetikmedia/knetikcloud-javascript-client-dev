...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.RevenueCountryReportResource();
  });
  ...
  describe('RevenueCountryReportResource', function() {
    it('should create an instance of RevenueCountryReportResource', function() {
      ...
      //var instane = new KnetikCloud.RevenueCountryReportResource();
      //expect(instance).to.be.a(KnetikCloud.RevenueCountryReportResource);
    });
