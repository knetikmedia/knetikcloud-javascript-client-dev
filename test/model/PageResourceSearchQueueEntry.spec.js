...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceSearchQueueEntry();
  });
  ...
  describe('PageResourceSearchQueueEntry', function() {
    it('should create an instance of PageResourceSearchQueueEntry', function() {
      // uncomment below and update the code to test PageResourceSearchQueueEntry
      //var instane = new KnetikCloud.PageResourceSearchQueueEntry();
      //expect(instance).to.be.a(KnetikCloud.PageResourceSearchQueueEntry);
    });
