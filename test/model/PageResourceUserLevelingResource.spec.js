...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceUserLevelingResource();
  });
  ...
  describe('PageResourceUserLevelingResource', function() {
    it('should create an instance of PageResourceUserLevelingResource', function() {
      // uncomment below and update the code to test PageResourceUserLevelingResource
      //var instane = new KnetikCloud.PageResourceUserLevelingResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceUserLevelingResource);
    });
