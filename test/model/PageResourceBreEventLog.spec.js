...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceBreEventLog();
  });
  ...
  describe('PageResourceBreEventLog', function() {
    it('should create an instance of PageResourceBreEventLog', function() {
      // uncomment below and update the code to test PageResourceBreEventLog
      //var instane = new KnetikCloud.PageResourceBreEventLog();
      //expect(instance).to.be.a(KnetikCloud.PageResourceBreEventLog);
    });
