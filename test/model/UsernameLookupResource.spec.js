...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.UsernameLookupResource();
  });
  ...
  describe('UsernameLookupResource', function() {
    it('should create an instance of UsernameLookupResource', function() {
      // uncomment below and update the code to test UsernameLookupResource
      //var instane = new KnetikCloud.UsernameLookupResource();
      //expect(instance).to.be.a(KnetikCloud.UsernameLookupResource);
    });
