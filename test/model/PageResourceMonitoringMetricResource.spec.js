...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceMonitoringMetricResource();
  });
  ...
  describe('PageResourceMonitoringMetricResource', function() {
    it('should create an instance of PageResourceMonitoringMetricResource', function() {
      // uncomment below and update the code to test PageResourceMonitoringMetricResource
      //var instane = new KnetikCloud.PageResourceMonitoringMetricResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceMonitoringMetricResource);
    });
