...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceBreGlobalResource();
  });
  ...
  describe('PageResourceBreGlobalResource', function() {
    it('should create an instance of PageResourceBreGlobalResource', function() {
      // uncomment below and update the code to test PageResourceBreGlobalResource
      //var instane = new KnetikCloud.PageResourceBreGlobalResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceBreGlobalResource);
    });
