...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceMonitoringAlertResource();
  });
  ...
  describe('PageResourceMonitoringAlertResource', function() {
    it('should create an instance of PageResourceMonitoringAlertResource', function() {
      // uncomment below and update the code to test PageResourceMonitoringAlertResource
      //var instane = new KnetikCloud.PageResourceMonitoringAlertResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceMonitoringAlertResource);
    });
