...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceSimpleWallet();
  });
  ...
  describe('PageResourceSimpleWallet', function() {
    it('should create an instance of PageResourceSimpleWallet', function() {
      // uncomment below and update the code to test PageResourceSimpleWallet
      //var instane = new KnetikCloud.PageResourceSimpleWallet();
      //expect(instance).to.be.a(KnetikCloud.PageResourceSimpleWallet);
    });
