...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.ActionVariableResource();
  });
  ...
  describe('ActionVariableResource', function() {
    it('should create an instance of ActionVariableResource', function() {
      ...
      //var instane = new KnetikCloud.ActionVariableResource();
      //expect(instance).to.be.a(KnetikCloud.ActionVariableResource);
    });
