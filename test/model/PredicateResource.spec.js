...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PredicateResource();
  });
  ...
  describe('PredicateResource', function() {
    it('should create an instance of PredicateResource', function() {
      // uncomment below and update the code to test PredicateResource
      //var instane = new KnetikCloud.PredicateResource();
      //expect(instance).to.be.a(KnetikCloud.PredicateResource);
    });
