...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.InvoicePaymentStatusRequest();
  });
  ...
  describe('InvoicePaymentStatusRequest', function() {
    it('should create an instance of InvoicePaymentStatusRequest', function() {
      ...
      //var instane = new KnetikCloud.InvoicePaymentStatusRequest();
      //expect(instance).to.be.a(KnetikCloud.InvoicePaymentStatusRequest);
    });
