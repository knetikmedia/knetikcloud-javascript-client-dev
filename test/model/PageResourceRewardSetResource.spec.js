...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceRewardSetResource();
  });
  ...
  describe('PageResourceRewardSetResource', function() {
    it('should create an instance of PageResourceRewardSetResource', function() {
      // uncomment below and update the code to test PageResourceRewardSetResource
      //var instane = new KnetikCloud.PageResourceRewardSetResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceRewardSetResource);
    });
