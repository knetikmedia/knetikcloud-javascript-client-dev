...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceUsageInfo();
  });
  ...
  describe('PageResourceUsageInfo', function() {
    it('should create an instance of PageResourceUsageInfo', function() {
      // uncomment below and update the code to test PageResourceUsageInfo
      //var instane = new KnetikCloud.PageResourceUsageInfo();
      //expect(instance).to.be.a(KnetikCloud.PageResourceUsageInfo);
    });
