...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceChatUserThreadResource();
  });
  ...
  describe('PageResourceChatUserThreadResource', function() {
    it('should create an instance of PageResourceChatUserThreadResource', function() {
      // uncomment below and update the code to test PageResourceChatUserThreadResource
      //var instane = new KnetikCloud.PageResourceChatUserThreadResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceChatUserThreadResource);
    });
