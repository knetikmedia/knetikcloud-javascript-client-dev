...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceCartSummary();
  });
  ...
  describe('PageResourceCartSummary', function() {
    it('should create an instance of PageResourceCartSummary', function() {
      // uncomment below and update the code to test PageResourceCartSummary
      //var instane = new KnetikCloud.PageResourceCartSummary();
      //expect(instance).to.be.a(KnetikCloud.PageResourceCartSummary);
    });
