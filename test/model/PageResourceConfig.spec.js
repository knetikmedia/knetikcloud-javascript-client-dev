...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceConfig();
  });
  ...
  describe('PageResourceConfig', function() {
    it('should create an instance of PageResourceConfig', function() {
      // uncomment below and update the code to test PageResourceConfig
      //var instane = new KnetikCloud.PageResourceConfig();
      //expect(instance).to.be.a(KnetikCloud.PageResourceConfig);
    });
