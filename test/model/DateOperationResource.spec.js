...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.DateOperationResource();
  });
  ...
  describe('DateOperationResource', function() {
    it('should create an instance of DateOperationResource', function() {
      // uncomment below and update the code to test DateOperationResource
      //var instane = new KnetikCloud.DateOperationResource();
      //expect(instance).to.be.a(KnetikCloud.DateOperationResource);
    });
