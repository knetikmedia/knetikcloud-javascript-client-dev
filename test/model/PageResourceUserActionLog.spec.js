...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceUserActionLog();
  });
  ...
  describe('PageResourceUserActionLog', function() {
    it('should create an instance of PageResourceUserActionLog', function() {
      // uncomment below and update the code to test PageResourceUserActionLog
      //var instane = new KnetikCloud.PageResourceUserActionLog();
      //expect(instance).to.be.a(KnetikCloud.PageResourceUserActionLog);
    });
