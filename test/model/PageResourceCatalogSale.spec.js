...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceCatalogSale();
  });
  ...
  describe('PageResourceCatalogSale', function() {
    it('should create an instance of PageResourceCatalogSale', function() {
      // uncomment below and update the code to test PageResourceCatalogSale
      //var instane = new KnetikCloud.PageResourceCatalogSale();
      //expect(instance).to.be.a(KnetikCloud.PageResourceCatalogSale);
    });
