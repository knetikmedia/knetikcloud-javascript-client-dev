...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceArticleResource();
  });
  ...
  describe('PageResourceArticleResource', function() {
    it('should create an instance of PageResourceArticleResource', function() {
      // uncomment below and update the code to test PageResourceArticleResource
      //var instane = new KnetikCloud.PageResourceArticleResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceArticleResource);
    });
