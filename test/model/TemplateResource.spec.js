...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.TemplateResource();
  });
  ...
  describe('TemplateResource', function() {
    it('should create an instance of TemplateResource', function() {
      // uncomment below and update the code to test TemplateResource
