...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.OperationDefinitionResource();
  });
  ...
  describe('OperationDefinitionResource', function() {
    it('should create an instance of OperationDefinitionResource', function() {
      // uncomment below and update the code to test OperationDefinitionResource
      //var instane = new KnetikCloud.OperationDefinitionResource();
      //expect(instance).to.be.a(KnetikCloud.OperationDefinitionResource);
    });
