...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.VendorEmailLookupResource();
  });
  ...
  describe('VendorEmailLookupResource', function() {
    it('should create an instance of VendorEmailLookupResource', function() {
      // uncomment below and update the code to test VendorEmailLookupResource
      //var instane = new KnetikCloud.VendorEmailLookupResource();
      //expect(instance).to.be.a(KnetikCloud.VendorEmailLookupResource);
    });
