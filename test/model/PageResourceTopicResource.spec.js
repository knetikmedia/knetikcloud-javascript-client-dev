...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceTopicResource();
  });
  ...
  describe('PageResourceTopicResource', function() {
    it('should create an instance of PageResourceTopicResource', function() {
      // uncomment below and update the code to test PageResourceTopicResource
      //var instane = new KnetikCloud.PageResourceTopicResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceTopicResource);
    });
