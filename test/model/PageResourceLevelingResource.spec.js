...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceLevelingResource();
  });
  ...
  describe('PageResourceLevelingResource', function() {
    it('should create an instance of PageResourceLevelingResource', function() {
      // uncomment below and update the code to test PageResourceLevelingResource
      //var instane = new KnetikCloud.PageResourceLevelingResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceLevelingResource);
    });
