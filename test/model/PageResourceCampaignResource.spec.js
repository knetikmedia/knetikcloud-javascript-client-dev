...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceCampaignResource();
  });
  ...
  describe('PageResourceCampaignResource', function() {
    it('should create an instance of PageResourceCampaignResource', function() {
      // uncomment below and update the code to test PageResourceCampaignResource
      //var instane = new KnetikCloud.PageResourceCampaignResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceCampaignResource);
    });
