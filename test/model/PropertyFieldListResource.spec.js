...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PropertyFieldListResource();
  });
  ...
  describe('PropertyFieldListResource', function() {
    it('should create an instance of PropertyFieldListResource', function() {
      ...
      //var instane = new KnetikCloud.PropertyFieldListResource();
      //expect(instance).to.be.a(KnetikCloud.PropertyFieldListResource);
    });
