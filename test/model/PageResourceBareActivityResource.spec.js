...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceBareActivityResource();
  });
  ...
  describe('PageResourceBareActivityResource', function() {
    it('should create an instance of PageResourceBareActivityResource', function() {
      // uncomment below and update the code to test PageResourceBareActivityResource
      //var instane = new KnetikCloud.PageResourceBareActivityResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceBareActivityResource);
    });
