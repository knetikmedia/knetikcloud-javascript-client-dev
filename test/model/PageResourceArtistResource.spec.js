...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceArtistResource();
  });
  ...
  describe('PageResourceArtistResource', function() {
    it('should create an instance of PageResourceArtistResource', function() {
      // uncomment below and update the code to test PageResourceArtistResource
      //var instane = new KnetikCloud.PageResourceArtistResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceArtistResource);
    });
