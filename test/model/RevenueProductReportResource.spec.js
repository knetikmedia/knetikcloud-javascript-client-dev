...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.RevenueProductReportResource();
  });
  ...
  describe('RevenueProductReportResource', function() {
    it('should create an instance of RevenueProductReportResource', function() {
      // uncomment below and update the code to test RevenueProductReportResource
      //var instane = new KnetikCloud.RevenueProductReportResource();
      //expect(instance).to.be.a(KnetikCloud.RevenueProductReportResource);
    });
