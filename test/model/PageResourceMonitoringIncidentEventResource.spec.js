...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceMonitoringIncidentEventResource();
  });
  ...
  describe('PageResourceMonitoringIncidentEventResource', function() {
    it('should create an instance of PageResourceMonitoringIncidentEventResource', function() {
      // uncomment below and update the code to test PageResourceMonitoringIncidentEventResource
      //var instane = new KnetikCloud.PageResourceMonitoringIncidentEventResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceMonitoringIncidentEventResource);
    });
