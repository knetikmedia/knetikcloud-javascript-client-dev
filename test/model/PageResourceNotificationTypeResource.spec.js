...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceNotificationTypeResource();
  });
  ...
  describe('PageResourceNotificationTypeResource', function() {
    it('should create an instance of PageResourceNotificationTypeResource', function() {
      // uncomment below and update the code to test PageResourceNotificationTypeResource
      //var instane = new KnetikCloud.PageResourceNotificationTypeResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceNotificationTypeResource);
    });
