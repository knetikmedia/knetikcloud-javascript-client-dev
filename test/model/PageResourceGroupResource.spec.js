...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceGroupResource();
  });
  ...
  describe('PageResourceGroupResource', function() {
    it('should create an instance of PageResourceGroupResource', function() {
      // uncomment below and update the code to test PageResourceGroupResource
      //var instane = new KnetikCloud.PageResourceGroupResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceGroupResource);
    });
