...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourcestring();
  });
  ...
  describe('PageResourcestring', function() {
    it('should create an instance of PageResourcestring', function() {
      // uncomment below and update the code to test PageResourcestring
      //var instane = new KnetikCloud.PageResourcestring();
      //expect(instance).to.be.a(KnetikCloud.PageResourcestring);
    });
