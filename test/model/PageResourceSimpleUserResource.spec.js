...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceSimpleUserResource();
  });
  ...
  describe('PageResourceSimpleUserResource', function() {
    it('should create an instance of PageResourceSimpleUserResource', function() {
      // uncomment below and update the code to test PageResourceSimpleUserResource
      //var instane = new KnetikCloud.PageResourceSimpleUserResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceSimpleUserResource);
    });
