...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceSavedAddressResource();
  });
  ...
  describe('PageResourceSavedAddressResource', function() {
    it('should create an instance of PageResourceSavedAddressResource', function() {
      // uncomment below and update the code to test PageResourceSavedAddressResource
      //var instane = new KnetikCloud.PageResourceSavedAddressResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceSavedAddressResource);
    });
