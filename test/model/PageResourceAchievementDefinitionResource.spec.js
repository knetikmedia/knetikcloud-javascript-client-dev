...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceAchievementDefinitionResource();
  });
  ...
  describe('PageResourceAchievementDefinitionResource', function() {
    it('should create an instance of PageResourceAchievementDefinitionResource', function() {
      // uncomment below and update the code to test PageResourceAchievementDefinitionResource
      //var instane = new KnetikCloud.PageResourceAchievementDefinitionResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceAchievementDefinitionResource);
    });
