...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.AudioPropertyDefinitionResource();
  });
  ...
  describe('AudioPropertyDefinitionResource', function() {
    it('should create an instance of AudioPropertyDefinitionResource', function() {
      ...
      //var instane = new KnetikCloud.AudioPropertyDefinitionResource();
      //expect(instance).to.be.a(KnetikCloud.AudioPropertyDefinitionResource);
    });
