...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.DeltaResource();
  });
  ...
  describe('DeltaResource', function() {
    it('should create an instance of DeltaResource', function() {
      // uncomment below and update the code to test DeltaResource
      //var instane = new KnetikCloud.DeltaResource();
      //expect(instance).to.be.a(KnetikCloud.DeltaResource);
    });
