...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.ChallengeEventResource();
  });
  ...
  describe('ChallengeEventResource', function() {
    it('should create an instance of ChallengeEventResource', function() {
      ...
      //var instane = new KnetikCloud.ChallengeEventResource();
      //expect(instance).to.be.a(KnetikCloud.ChallengeEventResource);
    });
