...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceUserBaseResource();
  });
  ...
  describe('PageResourceUserBaseResource', function() {
    it('should create an instance of PageResourceUserBaseResource', function() {
      // uncomment below and update the code to test PageResourceUserBaseResource
      //var instane = new KnetikCloud.PageResourceUserBaseResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceUserBaseResource);
    });
