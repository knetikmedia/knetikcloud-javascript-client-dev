...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceRevenueCountryReportResource();
  });
  ...
  describe('PageResourceRevenueCountryReportResource', function() {
    it('should create an instance of PageResourceRevenueCountryReportResource', function() {
      // uncomment below and update the code to test PageResourceRevenueCountryReportResource
      //var instane = new KnetikCloud.PageResourceRevenueCountryReportResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceRevenueCountryReportResource);
    });
