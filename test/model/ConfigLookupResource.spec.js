...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.ConfigLookupResource();
  });
  ...
  describe('ConfigLookupResource', function() {
    it('should create an instance of ConfigLookupResource', function() {
      // uncomment below and update the code to test ConfigLookupResource
      //var instane = new KnetikCloud.ConfigLookupResource();
      //expect(instance).to.be.a(KnetikCloud.ConfigLookupResource);
    });
