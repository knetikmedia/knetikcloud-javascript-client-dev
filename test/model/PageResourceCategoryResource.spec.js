...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceCategoryResource();
  });
  ...
  describe('PageResourceCategoryResource', function() {
    it('should create an instance of PageResourceCategoryResource', function() {
      // uncomment below and update the code to test PageResourceCategoryResource
      //var instane = new KnetikCloud.PageResourceCategoryResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceCategoryResource);
    });
