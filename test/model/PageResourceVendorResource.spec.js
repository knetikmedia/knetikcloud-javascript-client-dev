...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceVendorResource();
  });
  ...
  describe('PageResourceVendorResource', function() {
    it('should create an instance of PageResourceVendorResource', function() {
      // uncomment below and update the code to test PageResourceVendorResource
      //var instane = new KnetikCloud.PageResourceVendorResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceVendorResource);
    });
