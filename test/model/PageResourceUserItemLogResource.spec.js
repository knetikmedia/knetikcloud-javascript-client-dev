...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.PageResourceUserItemLogResource();
  });
  ...
  describe('PageResourceUserItemLogResource', function() {
    it('should create an instance of PageResourceUserItemLogResource', function() {
      // uncomment below and update the code to test PageResourceUserItemLogResource
      //var instane = new KnetikCloud.PageResourceUserItemLogResource();
      //expect(instance).to.be.a(KnetikCloud.PageResourceUserItemLogResource);
    });
