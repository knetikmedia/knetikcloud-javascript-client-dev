...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikCloud.CreateBillingAgreementRequest();
  });
  ...
  describe('CreateBillingAgreementRequest', function() {
    it('should create an instance of CreateBillingAgreementRequest', function() {
      ...
      //var instane = new KnetikCloud.CreateBillingAgreementRequest();
      //expect(instance).to.be.a(KnetikCloud.CreateBillingAgreementRequest);
    });
