...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.WebsocketSendTopicMessageEvent = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.BroadcastableEvent);
  }
  ...
  /**
   * Constructs a new <code>WebsocketSendTopicMessageEvent</code>.
   * @alias module:model/WebsocketSendTopicMessageEvent
   * @class
  ...
  /**
   * Constructs a <code>WebsocketSendTopicMessageEvent</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/WebsocketSendTopicMessageEvent} obj Optional instance to populate.
   * @return {module:model/WebsocketSendTopicMessageEvent} The populated <code>WebsocketSendTopicMessageEvent</code> instance.
   */
  ...
  var discriminatorValue = 'websocket_topic_message';
