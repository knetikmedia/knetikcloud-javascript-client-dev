...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BareChallengeActivityResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BareChallengeActivityResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikCloud) {
      root.KnetikCloud = {};
    }
    root.KnetikCloud.PageResourceBareChallengeActivityResource = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.BareChallengeActivityResource);
  }
}(this, function(ApiClient, BareChallengeActivityResource) {
  'use strict';
  ...
  var discriminatorValue = 'PageResource«BareChallengeActivityResource»';
