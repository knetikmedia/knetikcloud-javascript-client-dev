...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.PageResourceSimpleUserResource = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.SimpleUserResource);
  }
  ...
  /**
   * Constructs a new <code>PageResourceSimpleUserResource</code>.
   * @alias module:model/PageResourceSimpleUserResource
   * @class
   */
  ...
  /**
   * Constructs a <code>PageResourceSimpleUserResource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageResourceSimpleUserResource} obj Optional instance to populate.
   * @return {module:model/PageResourceSimpleUserResource} The populated <code>PageResourceSimpleUserResource</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [SimpleUserResource]);
      }
  ...
  var discriminatorValue = 'PageResource«SimpleUserResource»';


  /**
   * @member {Array.<module:model/SimpleUserResource>} content
   */
