...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BreRule'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BreRule'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikCloud) {
      root.KnetikCloud = {};
    }
    root.KnetikCloud.PageResourceBreRule = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.BreRule);
  }
}(this, function(ApiClient, BreRule) {
  'use strict';
  ...
  /**
   * Constructs a new <code>PageResourceBreRule</code>.
   * @alias module:model/PageResourceBreRule
   * @class
   */
  ...
  /**
   * Constructs a <code>PageResourceBreRule</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageResourceBreRule} obj Optional instance to populate.
   * @return {module:model/PageResourceBreRule} The populated <code>PageResourceBreRule</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [BreRule]);
      }
  ...
  var discriminatorValue = 'PageResource«BreRule»';


  /**
   * @member {Array.<module:model/BreRule>} content
   */
