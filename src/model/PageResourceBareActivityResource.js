...
(function(root, factory) {
  ...
  /**
   * Constructs a new <code>PageResourceBareActivityResource</code>.
   * @alias module:model/PageResourceBareActivityResource
   * @class
   */
  ...
  /**
   * Constructs a <code>PageResourceBareActivityResource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageResourceBareActivityResource} obj Optional instance to populate.
   * @return {module:model/PageResourceBareActivityResource} The populated <code>PageResourceBareActivityResource</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [BareActivityResource]);
      }
  ...
  var discriminatorValue = 'PageResource«BareActivityResource»';


  /**
   * @member {Array.<module:model/BareActivityResource>} content
   */
