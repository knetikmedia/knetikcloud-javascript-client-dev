...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BreTriggerResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./BreTriggerResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikCloud) {
      root.KnetikCloud = {};
    }
    root.KnetikCloud.PageResourceBreTriggerResource = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.BreTriggerResource);
  }
}(this, function(ApiClient, BreTriggerResource) {
  'use strict';
