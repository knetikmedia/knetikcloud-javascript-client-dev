...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.CoreActivitySettings = factory(root.KnetikCloud.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>CoreActivitySettings</code>.
   * @alias module:model/CoreActivitySettings
   * @class
   */
  ...
  /**
   * Constructs a <code>CoreActivitySettings</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CoreActivitySettings} obj Optional instance to populate.
   * @return {module:model/CoreActivitySettings} The populated <code>CoreActivitySettings</code> instance.
   */
  ...
  var discriminatorValue = 'CoreActivitySettings';
   ...
   * @member {module:model/CoreActivitySettings.HostOptionEnum} host_option
   */
   ...
   * @member {module:model/CoreActivitySettings.ResultsTrustEnum} results_trust
   */
