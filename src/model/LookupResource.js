...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.LookupResource = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.ExpressionResource);
  }
  ...
  /**
   * The LookupResource model module.
   * @module model/LookupResource
   * @version 3.0.11
   */

  /**
   * Constructs a new <code>LookupResource</code>.
   * Expressions are instructions for the rule engine to resolve certain values. For example instead of &#x60;user 1&#x60; it&#39;d state &#x60;user provided by the event&#x60;. Full list and definitions available at GET /bre/expressions.
   * @alias module:model/LookupResource
   * @class
   */
  ...
  /**
   * Constructs a <code>LookupResource</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LookupResource} obj Optional instance to populate.
   * @return {module:model/LookupResource} The populated <code>LookupResource</code> instance.
   */
  ...
  var discriminatorValue = 'LookupResource';
