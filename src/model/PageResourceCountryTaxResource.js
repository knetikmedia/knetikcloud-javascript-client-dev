...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CountryTaxResource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./CountryTaxResource'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikCloud) {
      root.KnetikCloud = {};
    }
    root.KnetikCloud.PageResourceCountryTaxResource = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.CountryTaxResource);
  }
}(this, function(ApiClient, CountryTaxResource) {
  'use strict';
  ...
  var discriminatorValue = 'PageResource«CountryTaxResource»';
