...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    module.exports = factory(require('../ApiClient'), require('./Config'));
  } else {
    // Browser globals (root is window)
    if (!root.KnetikCloud) {
      root.KnetikCloud = {};
    }
    root.KnetikCloud.PageResourceConfig = factory(root.KnetikCloud.ApiClient, root.KnetikCloud.Config);
  }
  ...
  /**
   * Constructs a new <code>PageResourceConfig</code>.
   * @alias module:model/PageResourceConfig
   * @class
   */
  ...
  /**
   * Constructs a <code>PageResourceConfig</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageResourceConfig} obj Optional instance to populate.
   * @return {module:model/PageResourceConfig} The populated <code>PageResourceConfig</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('content')) {
        obj['content'] = ApiClient.convertToType(data['content'], [Config]);
      }
  ...
  var discriminatorValue = 'PageResource«Config»';


  /**
   * @member {Array.<module:model/Config>} content
   */
