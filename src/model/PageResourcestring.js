...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikCloud.PageResourcestring = factory(root.KnetikCloud.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>PageResourcestring</code>.
   * @alias module:model/PageResourcestring
   * @class
   */
  ...
  /**
   * Constructs a <code>PageResourcestring</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PageResourcestring} obj Optional instance to populate.
   * @return {module:model/PageResourcestring} The populated <code>PageResourcestring</code> instance.
   */
  ...
  var discriminatorValue = 'PageResource«string»';
